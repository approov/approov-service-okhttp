...
Please see the [Quickstart](https://github.com/approov/quickstart-android-kotlin-okhttp) for example integration.
...
Please see the [INTERFACE.md](INTERFACE.md) for more information on the Approov Service for OkHttp.
